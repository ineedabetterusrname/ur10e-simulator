...
*V7 - 11-09-2025 modified by Joerg Siegert
* The maximum adjustable values for linear and angular maximum speeds and accelerations were copied from the UR controller.
...
cart_max_lin_speed 3000;
cart_max_lin_acc 150000;
* 180 deg/s
cart_max_rot_speed 3.1416; 
* 2292 deg/s2
cart_max_rot_acc 40.00295;

* ER9489399: directly support rotational speed i
